...
describe('ThetaDecayBar', () => {
  test('renders nothing when dte is 0', () => {
    const { container } = render(
      <ThetaDecayBar theta={-0.05} dte={0} quantity={1} />
    );
  ...
  test('renders nothing when theta is 0', () => {
    const { container } = render(
      <ThetaDecayBar theta={0} dte={10} quantity={1} />
    );
    expect(container.innerHTML).toBe('');
  });
  ...
  test('shows red bar color when dte <= 3', () => {
    const { container } = render(
      <ThetaDecayBar theta={-0.05} dte={2} quantity={1} />
    );
  ...
  test('shows amber bar color when dte <= 7', () => {
    const { container } = render(
      <ThetaDecayBar theta={-0.05} dte={5} quantity={1} />
    );
  ...
  test('shows yellow bar color when dte <= 14', () => {
    const { container } = render(
      <ThetaDecayBar theta={-0.05} dte={10} quantity={1} />
    );
  ...
  test('shows blue bar color when dte > 14', () => {
    const { container } = render(
      <ThetaDecayBar theta={-0.05} dte={30} quantity={1} />
    );
